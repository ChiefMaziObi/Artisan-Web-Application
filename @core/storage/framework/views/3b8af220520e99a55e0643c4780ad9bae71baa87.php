                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.scripts.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <br>
                            <div class="form-group">
                                <label for="calendly_url"><?php echo e(__('Calendly Url')); ?></label>
                                <input type="text" name="calendly_url"  class="form-control" value="<?php echo e(get_static_option('calendly_url')); ?>">
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\qixer_bytesed_laravel\@core\resources\views/backend/general-settings/thid-party.blade.php ENDPATH**/ ?>